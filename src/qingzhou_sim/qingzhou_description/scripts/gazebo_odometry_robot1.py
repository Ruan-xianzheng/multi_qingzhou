...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/robot1/odom', Odometry, queue_size=1) # Todo: /odom
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = 'robot1/odom'
        cmd.child_frame_id = 'robot1/base_footprint'
...
if __name__ == '__main__':
    rospy.init_node("robot1_gazebo_odometry_node")
    node = OdometryNode()
    rospy.spin()
