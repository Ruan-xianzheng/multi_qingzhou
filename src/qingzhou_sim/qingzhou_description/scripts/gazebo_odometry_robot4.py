...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/robot4/odom', Odometry, queue_size=1) # Todo: /odom
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index('robot4::base_footprint')
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = 'robot4/odom'
        cmd.child_frame_id = 'robot4/base_footprint'
...
if __name__ == '__main__':
    rospy.init_node("robot4_gazebo_odometry_node")
    node = OdometryNode()
    rospy.spin()
