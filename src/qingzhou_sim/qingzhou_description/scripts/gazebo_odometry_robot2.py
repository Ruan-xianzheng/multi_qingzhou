...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/robot2/odom', Odometry, queue_size=1) # Todo: /odom
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = 'robot2/odom'
        cmd.child_frame_id = 'robot2/base_footprint'
...
if __name__ == '__main__':
    rospy.init_node("robot2_gazebo_odometry_node")
    node = OdometryNode()
    rospy.spin()
